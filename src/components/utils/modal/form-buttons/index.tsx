...
const FormButtons = ({
  ...
  const submitBackground = `${
    isValid
      ? "bg-purple-400 hover:bg-purple-500 ease-in delay-50 transition text-white cursor-pointer"
  ...
  return (
    <div className="flex w-full items-center justify-center">
      ...
      <button
        className={`flex w-full items-center justify-center rounded-br-md p-2 text-xl font-bold md:text-2xl ${submitBackground} border-0`}
        disabled={!isValid}
        type="submit"
      >
        {submitTitle}
